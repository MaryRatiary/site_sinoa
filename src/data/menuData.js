    ...
    columns: [
      {
        title: 'KPOP Merch',
        items: [
          { label: 'Lightsticks', slug: 'lightsticks', image: '/menu/k-pop/lightstick.jpg' },
          { label: 'Box & Coffrets', slug: 'box-coffrets', image: '/menu/k-pop/calendar.png' },
          { label: 'Figurines & Poupées', slug: 'figurines-poupees', image: '/menu/k-pop/figurine.png' },
          { label: 'Coques', slug: 'coques', image: '/menu/k-pop/coques.jpg' },
          { label: 'Photocards', slug: 'photocards', image: '/menu/k-pop/photocard.jpg' },
          { label: 'Posters', slug: 'posters', image: '/menu/k-pop/poster.jpg' },
        ],
      },
      {
        title: 'Vêtement KPOP',
        items: [
          { label: 'T-Shirts', slug: 'vetement-t-shirts', image: '/menu/k-pop/t-shirt.jpg' },
          { label: 'Sweats & Pulls', slug: 'vetement-sweats', image: '/menu/k-pop/hoodie.jpg' },
          { label: 'Masques', slug: 'masques', image: '/menu/k-pop/masque.jpg' },
          { label: 'Casquettes', slug: 'casquettes', image: '/menu/k-pop/casquette.jpg' },
          { label: 'Bonnets & Bobs', slug: 'bonnets-bobs', image: '/menu/k-pop/bonnet.jpg' },
          { label: 'Gants & Mitaines', slug: 'gants-mitaines', image: '/menu/k-pop/gants.jpg' },
        ],
      },
      {
        title: 'Bijoux KPOP',
        items: [
          { label: 'Bagues', slug: 'bagues', image: '/menu/k-pop/bague.jpg' },
          { label: 'Colliers', slug: 'colliers', image: '/menu/k-pop/collier.jpg' },
          { label: "Boucles d'oreilles", slug: 'boucles-oreilles', image: '/menu/k-pop/boucle-oreille.jpg' },
          { label: 'Bracelets', slug: 'bracelets', image: '/menu/k-pop/bracelet.jpg' },
          { label: 'Porte-clés', slug: 'porte-cles', image: '/menu/k-pop/porte-cle.png' },
          { label: 'Serre-Têtes', slug: 'serre-tetes', image: '/menu/k-pop/serre-tete.png' },
        ],
      },
      {
        title: 'Accessoires KPOP',
        items: [
          { label: 'Peluches', slug: 'peluches', image: '/menu/k-pop/peluche.jpg' },
          { label: 'Sacs à dos', slug: 'sacs-a-dos', image: '/menu/k-pop/sac.jpg' },
          { label: 'Mugs & Gourdes', slug: 'mugs-gourdes', image: '/menu/k-pop/mug.jpg' },
          { label: 'Trousses', slug: 'trousses', image: '/menu/k-pop/trousse.jpg' },
          { label: 'Portefeuilles', slug: 'portefeuilles', image: '/menu/k-pop/portefeuille.jpg' },
          { label: 'Totebags', slug: 'totebags', image: '/menu/k-pop/sac-totebag.jpg' },
        ],
      },
    ]
  },
