import { Star, MessageCircle, User, Heart, ThumbsUp } from 'lucide-react';
...
const SAMPLE_REVIEWS = [
  {
    ...
    comment: "Vraiment satisfait de mon achat. La qualité est impeccable et la livraison a été rapide. Je recommande vivement !",
    helpful: 24,
    likes: 45,
    verified: true
  },
  {
    ...
    comment: "Les produits de cette catégorie sont vraiment de haute qualité. Très heureux de mon achat et je vais revenir.",
    helpful: 18,
    likes: 32,
    verified: true
  },
  {
    ...
    date: "2026-03-15",
    title: "Bien, mais...",
    comment: "Bon rapport qualité-prix. Un petit délai dans la livraison mais rien de grave. Je suis globalement satisfait.",
    helpful: 12,
    likes: 21,
    verified: true
  },
  {
    ...
    date: "2026-03-12",
    title: "Parfait !",
    comment: "Service client réactif, produits de qualité, emballage soigné. Tout est au rendez-vous. Merci !",
    helpful: 15,
    likes: 28,
    verified: true
  },
  {
    ...
    comment: "Produits conformes à la description. Équipe très professionnelle. Je recommande sans hésiter.",
    helpful: 20,
    likes: 38,
    verified: true
  },
...
export default function CustomerReviews({ categoryName }) {
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="space-y-3">
              {[5, 4, 3, 2, 1].map((stars) => {
                const count = SAMPLE_REVIEWS.filter(r => r.rating === stars).length;
