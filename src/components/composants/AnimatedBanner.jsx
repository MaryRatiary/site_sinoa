...
const AnimatedBanner = ({
  text = "HUNTRIX OPÉRATIONS SPÉCIALES : JUSQU'À -50% • LIVRAISON OFFERTE PARTOUT DANS LE MONDE • NOUVELLE COLLECTION K-FASHION DISPONIBLE • K-BEAUTY EXCLUSIVE POUR HUNTERS • STOCK LIMITÉ SUR LES FIGURINES • REJOINS LE PROGRAMME VIP SLAYER •"
}) => {
