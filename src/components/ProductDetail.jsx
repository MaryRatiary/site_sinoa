...
const ProductDetail = ({ product }) => {
  ...
  const productDetails = {
    ...
    colors: product.colors || ['Noir', 'Blanc', 'Rose', 'Bleu'],
    inStock: product.inStock !== false,
    stockQuantity: product.stockQuantity || 10,
    material: product.material || 'Coton 100%',
    care: product.care || 'Lavage à l\'eau froide, séchage à l\'air',
  ...
  const handleAddToCart = () => {
    if (!selectedSize && productDetails.sizes.length > 0) {
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex items-baseline gap-3">
              ...
              {!productDetails.inStock && (
                <span className="text-red-500 font-semibold text-sm">Rupture de stock</span>
              )}
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full h-24 p-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-pink-600 resize-none"
              />
            </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="text-sm text-blue-900 space-y-2">
                <p><strong>📦 {productDetails.shipping}</strong></p>
                <p><strong>✓ {productDetails.warranty}</strong></p>
              </div>
            </div>
            ...
            <div className="border-t pt-6 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-4 pt-4">
                ...
                <div>
                  ...
                  <p className="font-semibold text-gray-900">{productDetails.care}</p>
                </div>
              </div>
            </div>
          </div>
